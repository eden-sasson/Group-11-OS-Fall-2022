...
{
	elevatorLock->Acquire(); //mutual exclusivity
	//if (numPeopleIn > 0)
...
//I don't think we need these because we need mutual exclusivity but its here for thought
//Lock * goingUp = new Lock("Upward");
//Lock * goingDown = new Lock("Downward");
